...
public class Seeder implements CommandLineRunner {
    ...
    public void run(String[] arg){
        Users u1= userRepository.save(new Users("perico","eduardo","apellido","1234","correo@correo.com"));
        Users u2= userRepository.save(new Users("carrasco","sofia","malepo","3566","dsadad@correo.com"));
        Users u3= userRepository.save(new Users("malasco","fermin","asdadasd","89763","dededed@correo.com"));
       ...
       /* Backgrounds bc1=backgroundRepository.save(new Backgrounds("mu solo","esta mu solo"));
        ...
        Backgrounds bc1=backgroundRepository.save(new Backgrounds("mu solo"));
        Backgrounds bc2=backgroundRepository.save(new Backgrounds("solito"));
        Backgrounds bc3=backgroundRepository.save(new Backgrounds("niñato"));
